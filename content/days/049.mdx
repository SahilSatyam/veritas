...
Before adding new data, clean the existing data. **Cleanlab** uses confident learning to identify likely label errors—samples that confuse your model because _they are wrong_, not because the model is weak.
