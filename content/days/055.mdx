...
4. **Documentation Governance:** Pair bias mitigation with Google's **Model Cards for Model Reporting** standard. A Model Card that explicitly documents the mitigation technique applied, the groups tested, and the resulting disparity ratios turns your re-weighting work into auditable, shareable governance evidence—a complementary layer to the technical mitigation itself.
...
- **Standard:** Google's [Model Cards for Model Reporting](https://modelcards.withgoogle.com/about) (Mitchell et al., 2019) – Provides the governance documentation template for recording bias mitigation outcomes; widely adopted as a complementary artifact to technical mitigation.
