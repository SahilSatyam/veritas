...
- **Standard Agent Benchmarks**: _AgentBench_ (evaluating LLMs as agents in multi-turn environments), _WebArena_ (website task-solving benchmark), and _tau-bench_ (specifically built for evaluating tool-use and API interaction trajectories).
