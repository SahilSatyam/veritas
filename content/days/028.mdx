...
- **768 dimensions (BERT/SBERT / local BGE-large):** Good for simple sentence similarity and fast to index.
- **1536 dimensions (OpenAI text-embedding-3-small):** The standard workhorse.
- **3072 dimensions (OpenAI text-embedding-3-large / Cohere Embed v3 / Voyage AI / Jina v3):** High definition. Captures subtle nuances, multilingual support, and custom domain nuances (e.g., distinguishing "legal contract" from "binding agreement").
