...
> **Note:** Many frontier models (GPT-5.5, Claude Opus 4.8, Gemini 3.1 Pro) now perform internal chain-of-thought automatically without explicit prompting. However, _explicit_ CoT prompting via XML tags remains best practice for auditable, controllable reasoning in production systems.
...
A third paradigm, pioneered by OpenAI's o1/o3/o4-mini series and Anthropic's Claude Opus with extended thinking mode, scales reasoning by allocating additional **inference-time compute** rather than relying on prompt structure.
