...
- **Conformal Prediction (2026 Frontier):** Beyond calibration, conformal prediction provides _prediction sets_ with statistical guarantees. If you want 95% coverage, conformal methods guarantee it—regardless of the model. See the **MAPIE** library for Python implementation.
