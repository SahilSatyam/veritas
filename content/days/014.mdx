...
- **Legal Mandate:** Under the **EU AI Act** (entered into force August 2024), Model Cards are no longer a voluntary best practice for high-risk AI systems — they are a **compliance requirement**. High-risk AI providers must supply technical documentation that includes the model's intended purpose, performance metrics, known limitations, and bias evaluations. The high-risk rules apply from August 2026; preparation must begin now.
...
For teams building high-risk AI systems under the EU AI Act, comprehensive technical documentation (equivalent to a thorough Model Card) is a **legal prerequisite** for market placement. The EU AI Act's high-risk provisions take full effect in August 2026. Organizations without documentation infrastructure in place today will face compliance emergencies at launch.
...
- **Regulation:** [EU AI Act Annex IV](https://artificialintelligenceact.eu/annex/4/) (Technical Documentation Requirements for High-Risk AI — the mandatory successor to voluntary Model Cards).
